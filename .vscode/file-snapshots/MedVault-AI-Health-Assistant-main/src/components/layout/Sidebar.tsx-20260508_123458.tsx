...
import { LayoutDashboard, MessageSquare, FileText, Bell, User, Settings, HeartPulse, BadgeCheck } from 'lucide-react';
...
const Sidebar = () => {
  const navItems = [
    ...
    { name: 'User Info', path: '/user-info', icon: <BadgeCheck size={20} /> },
